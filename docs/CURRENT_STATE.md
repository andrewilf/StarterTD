...
- Movement input: selected walkable champions move with left-click drag-and-release from the selected tower tile; right-click no longer redirects laser, it deselects the selected laser only
