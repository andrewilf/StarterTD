    ...
    public static TowerStats GetStats(TowerType type, int level)
    {
        return (type, level) switch
        {
            ...
            (TowerType.Gun, 1) => new TowerStats(
                ...
                Cost: 50, UpgradeCost: 40, MovementCost: 300, IsAOE: false, AOERadius: 0f,
                Color: new Color(65, 105, 225)),  // Royal Blue

            (TowerType.Gun, 2) => new TowerStats(
                "Gun Tower Mk2", Range: 150f, Damage: 15f, FireRate: 0.2f,
                Cost: 50, UpgradeCost: 0, MovementCost: 300, IsAOE: false, AOERadius: 0f,
            ...
            (TowerType.Cannon, 1) => new TowerStats(
                ...
                Cost: 80, UpgradeCost: 60, MovementCost: 500, IsAOE: true, AOERadius: 50f,
            ...
            (TowerType.Cannon, 2) => new TowerStats(
                ...
                Cost: 80, UpgradeCost: 0, MovementCost: 500, IsAOE: true, AOERadius: 70f,
            ...
            (TowerType.Sniper, 1) => new TowerStats(
                ...
                Cost: 100, UpgradeCost: 80, MovementCost: 700, IsAOE: false, AOERadius: 0f,
            ...
            (TowerType.Sniper, 2) => new TowerStats(
                ...
                Cost: 100, UpgradeCost: 0, MovementCost: 700, IsAOE: false, AOERadius: 0f,
